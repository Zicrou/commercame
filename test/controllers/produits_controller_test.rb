...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference("Produit.count") do
      post produits_url, params: { produit: { image: @produit.image, name: @produit.name, price: @produit.price, quantity: @produit.quantity } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { image: @produit.image, name: @produit.name, price: @produit.price, quantity: @produit.quantity } }

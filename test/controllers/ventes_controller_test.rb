...
class VentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vente" do
    assert_difference("Vente.count") do
      post ventes_url, params: { vente: { price: @vente.price, produit_id: @vente.produit_id, quantity: @vente.quantity } }
    end
  ...
  test "should update vente" do
    patch vente_url(@vente), params: { vente: { price: @vente.price, produit_id: @vente.produit_id, quantity: @vente.quantity } }
